  ...
  <section>
    <div class="font-serif">
      ...
      <div class="text-center mb-20">
        ...
        <br>
        <p>そんなあなたの背中を押してくれる「書籍紹介診断アプリ」です。</p>
        <br>
        ...
        <div class="pt-12 pb-12 flex ">
          <div class="flex-1  text-center w-1/3 mx-8">
            <div class="border-4 border-white rounded-full">
              <p class=" py-2 text-lg">自分が何をやりたいのか分からない</p>
            </div>
            <p class="my-4">何がやりたいか分からないのは「視野が広がっていない」が原因と考えます。本を通して様々な価値観に触れ新しい自分を見つけましょう。NewSelfはそのきっかけを作ってくれます。</p>
          </div>
          <div class="flex-1  text-center w-1/3 mx-8">
            <div class="border-4 border-white rounded-full">
              <p class="py-2 text-lg">自分を変えたい</p>
            </div>
            <p class="my-4">自分を変えようと行動するが、継続できずに諦めてしまう方が多い印象があります。それは「マインド」が変わっていないからです。私自身本から多くのことを学びました。NewSelfではあなたの「マインド」を変える第１歩をサポートします。</p>
          </div>
          <div class="flex-1  text-center w-1/3 mx-8">
            <div class="border-4 border-white rounded-full">
             <p class=" py-2 text-lg ">読書したいが読んだら良いか分からない</p>
            </div>
            <p class="my-4">読書したいが何を読めば良いか分からないことも多いと思います。NewSelfでは診断を通してあなたにピッタリであろう書籍を紹介してくれます。</p>
          </div>
        </div>
      </div>
